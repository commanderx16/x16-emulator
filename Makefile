...
OBJS = cpu/fake6502.o memory.o disasm.o video.o ps2.o i2c.o via.o loadsave.o vera_spi.o audio.o vera_pcm.o vera_psg.o sdcard.o main.o debugger.o javascript_interface.o joystick.o rendertext.o keyboard.o icon.o
