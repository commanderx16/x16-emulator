...
OBJS = cpu/fake6502.o memory.o disasm.o video.o ps2.o via.o loadsave.o vera_uart.o vera_spi.o sdcard.o main.o debugger.o javascript_interface.o joystick.o rendertext.o keyboard.o
