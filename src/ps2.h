...
void ps2_outbuffer_prepend(int i, uint8_t byte);

uint8_t ps2_inbuffer_get_count(int i);
uint8_t ps2_inbuffer_get_oldest(int i);
uint8_t ps2_inbuffer_pop_oldest(int i);
